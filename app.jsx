...
var Clock = React.createClass({
    ...
    render: function () {
        return (
            <h1 className="text-center wall-clock">
        ...
        return (
            <div className="bell">
                <audio ref="audio" loop>
                    ...
                    Ваш браузер не поддерживает аудио-файл данного формата
                </audio>
                <div className="form">
    ...
    render: function () {
        ...
        var list = function () {
            if (this.state.data.length == 0) {
                return (
                    <li className="list-group-item">Нет активных таймеров</li>
                );
            } else {
                return alarmNodes;
            }
                ...
                <div className="alarm-container">
                    <div className="alarm-digits">
                        ...
                        <AlarmDigit
                            ...
                            onBorrow={this.handleBorrow.bind(
                                this,
                                "minuteDigit"
                            )}
                            ref="secondDigit"
